...
<title class="text-center">Edit</title>
</head>

<body style="background: deepskyblue; ">
    <h1 class="text-center p-3 border border-white container rounded mt-3 mb-5">Edit record</h1>
    <form id="frmOsoba" method="POST" action="__DIR__. '/../code/edit.code.php'" class="container">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-4 offset-2">
                    <button name="btnEdit" class="btn  btn-success  ">Update</button>
                </div>
                <div class="col-4">
